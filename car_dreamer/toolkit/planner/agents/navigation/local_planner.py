...
log = get_logger(log_dir=".", job_name="local_planner")
...
class LocalPlanner:
    ...
    def __init__(self, vehicle, opt_dict={}, map_inst=None):
        ...
        if map_inst:
            if isinstance(map_inst, carla.Map):
                ...
                log.warning("Warning: Ignoring the given map as it is not a 'carla.Map'")
    ...
    def set_speed(self, speed):
        ...
        if self._follow_speed_limits:
            log.warning("WARNING: The max speed is currently set to follow the speed limits. " "Use 'follow_speed_limits' to deactivate this")
